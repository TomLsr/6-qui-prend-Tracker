    ...
    Tables: {
      ...
      games: {
        Row: {
          ...
          date: string;
          playerIds: string[];
          // FIX: Using 'any' for JSONB columns 'rounds' and 'totals' to prevent Supabase
          ...
          // The previous custom 'Json' type was too complex and caused inference failures across the entire Database type.
          rounds: any;
          totals: any;
          winnerId?: string;
          loserId?: string;
